...
<title>IDBI ASSIGNMENT REGISTRATION</title>
...
<body>
	<!-- <form action="register" method="post">
		...
		<label>Mobile Number :</label><input type="text" name="moNumber" required><br><br>
		...
		<div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
			<div class="wrapper wrapper--w680">
				<div class="card card-4">
					<div class="card-body">
						<h2 class="title">IDBI Registration Form</h2>
						<form method="POST">
							...
							<div class="row row-space">
								...
								<div class="col-2">
									<div class="input-group">
										...
										<input class="input--style-4" type="text" name="moNumber" required>
									</div>
								</div>
							</div>
							<div class="row row-space">
